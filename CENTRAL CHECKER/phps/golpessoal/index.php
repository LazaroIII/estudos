...
<head>
	...
	<meta name="description" content="GOL PESSOAL CHECADOR" />
	<meta name="author" content="GOL PESSOAL CHECADOR" />
	<title>TECHNOLOGY CHECKER GOL PESSOAL CHECADOR</title>
...
<script type="text/javascript">
		...
		function PARARLoading(bool){
			...
			updateTitle('GOL PESSOAL CHECADOR');
		}
		...
		function OKTY(lstMP, curMP,  delim, cEmail, maxFail, failed){
			...
			ajaxCall = $.ajax({
				...
				beforeSend: function (e) {
					updateTitle(lstMP[curMP] + ' - GOL PESSOAL CHECADOR');
...
<div class="main-content">
 <section id="main" class=""><center><h1>GOL PESSOAL CHECADOR</h1>
...
<form method="post">
	<div align="center">
		<textarea name="mailpass" id="mailpass" cols="80" rows="10">
<?php
