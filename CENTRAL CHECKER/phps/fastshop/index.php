...
<head>
	...
	<meta name="description" content="FAST SHOP CHECADOR" />
	<meta name="author" content="FAST SHOP CHECADOR" />
	<title>TECHNOLOGY CHECKER FAST SHOP CHECADOR</title>
...
<script type="text/javascript">
		...
		function PARARLoading(bool){
			...
			updateTitle('FAST SHOP CHECADOR');
		}
		...
		function OKTY(lstMP, curMP,  delim, cEmail, maxFail, failed){
			...
			ajaxCall = $.ajax({
				...
				beforeSend: function (e) {
					updateTitle(lstMP[curMP] + ' - FAST SHOP CHECADOR');
...
<div class="main-content">
 <section id="main" class=""><center><h1>FAST SHOP CHECADOR</h1>
