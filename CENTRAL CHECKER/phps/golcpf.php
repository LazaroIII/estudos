...
class cURL {
    ...
    function doRequest($method, $url) {
        ...
        curl_setopt($ch, CURLOPT_COOKIEJAR, getcwd().'/GOL.txt'); //COOKIES  DO NAVEGADOR
        curl_setopt($ch, CURLOPT_COOKIEFILE, getcwd().'/GOL.txt'); //COOKIES DO NAVEGADOR
        curl_setopt($ch, CURLOPT_REFERER, 'http://www.voeazul.com.br/');
...
<center><h1>GOL EXTRACT CPF</h1></center>
<form method="post">
...
$checked++;
	...
	//RESULTADOS DE CAPUTRA
		if (stristr($b,'Sair') !== false) {
			$cpf = getStr($b,'id="memberDocument">','</span><br>');
