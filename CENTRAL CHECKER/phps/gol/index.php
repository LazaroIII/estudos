...
<head>
	...
	<meta name="description" content="GOL CHECADOR" />
	<meta name="author" content="GOL CHECADOR" />
	<title>TECHNOLOGY CHECKER GOL CHECADOR</title>
		...
		function OKTY(lstMP, curMP,  delim, cEmail, maxFail, failed){
			...
			ajaxCall = $.ajax({
				...
				beforeSend: function (e) {
					updateTitle(lstMP[curMP] + ' - GOL CHECADOR');
...
<div class="main-content">
 <section id="main" class=""><center><h1>GOL CHECADOR</h1>
